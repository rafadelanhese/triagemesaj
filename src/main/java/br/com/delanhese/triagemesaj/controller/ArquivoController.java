...
public class ArquivoController {
    ...
    public ArquivoController(String triagem, String banco) throws FileNotFoundException {
        this.listaProcesso = new CsvToBeanBuilder(new FileReader(triagem)).withType(Processo.class).withSkipLines(1)
                .withSeparator(';').build().parse();
        this.listaPalavraChave = new CsvToBeanBuilder(new FileReader(banco)).withType(PalavraChave.class)
