...
public class TriagemEsajMain {
    ...
    public static void main(String[] args) {
        if (!ArquivoController.diretorioTriagemExiste()) {
            ...
            String caminhoArquivoTriagem = JOptionPane.showInputDialog(null,
                    "Insira o caminho do arquivo de processos a ser triado");
            ...
            if (caminhoArquivoTriagem.isEmpty() || caminhoBancoDeDados.isEmpty()) {
                ...
                try {
                    ArquivoController arquivoController = new ArquivoController(caminhoArquivoTriagem,
                            caminhoBancoDeDados);
